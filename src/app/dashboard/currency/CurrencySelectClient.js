...
export function CurrencySelectClient() {
  ...
  return (
    ...
    <div className="currency-select-screen">

      <header className="currency-select-header">

        <Link href={returnTo} className="currency-select-back" aria-label="Go back" onClick={clearCurrencyReturnPath}>
